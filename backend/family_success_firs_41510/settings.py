"""
Django settings for family_success_firs_41510 project.
...
ROOT_URLCONF = 'family_success_firs_41510.urls'
...
WSGI_APPLICATION = 'family_success_firs_41510.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "family_success_firs_41510 API",
    "DESCRIPTION": "API documentation for family_success_firs_41510 App",
    "VERSION": "v1",
}
